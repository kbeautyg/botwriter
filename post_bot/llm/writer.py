...
def _build_user_prompt(
    *,
    ...
    sections.append(
        "\n═══ ЭТАЛОНЫ СТИЛЯ (ТВОЯ ГЛАВНАЯ ОПОРА — смотри на каждый и соблюдай интонацию) ═══\n"
        "Это РЕАЛЬНЫЕ посты автора. Они показывают как он пишет: открытия, структура, "
        "длина абзацев, эмодзи, концовки, лексика. Перед написанием — внимательно прочти "
        "ВСЕ эталоны. Особенно тот, который ближе всего по жанру. Подражай его ритму "
        "и интонации, НО НЕ КОПИРУЙ его конкретные слова и фразы дословно."
    )
